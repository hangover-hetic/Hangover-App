import {Image, TouchableHighlight, View, StyleSheet, TouchableOpacity} from 'react-native';
...
import {FESTIVAL_ROUTE} from "../pages/Main/routes";
import Toast from "react-native-root-toast";

const CardCarouselFestival = ({item, index, onPress}) => {
