  ...
  return (
    ...
    >
      <Pressable
        ...
        onPress={() => {
          bindSelected('Tous'), setUserOption('Tous');
        }}
      >
        {/* add style here */}
        ...
        <LinearGradient
          ...
          colors={
            'Tous' === userOption ? ['#feac5e', '#c779d0', '#4bc0c8'] : ['#858585', '#858585']
          }
          style={{ borderRadius: 25 }}
        >
          <View style={styles.circleGradient}>
            <Text style={'Tous' === userOption ? styles.textSelected : styles.textUnselected}>
              Tous
            </Text>
          </View>
        </LinearGradient>
      ...
      {data.map((item, index) => {
        return (
          <Pressable
            ...
            key={'radio-' + index}
            onPress={() => {
              bindSelected(item.value), setUserOption(item.value);
            }}
          >
            <LinearGradient
              start={[0, 0.5]}
