...
import {
    ...
    SafeAreaView,
    Modal,
    Pressable, TouchableNativeFeedback, TouchableHighlight,
} from 'react-native';
...
import {INSCRIPTIONS_ROUTE} from "../routes";
import {setIsActualSelectedFestivals} from "../../../redux/Festival/festival-actions";
...
class Festival extends React.Component {
                ...
                <ScrollContainer style={styles.lineUpDrawer}>
                    ...
                    <WhiteSpan
                        content={
                            festival.name +
                            ' ━━━━━ ' +
                            dayjs(festival.startDate).format('DD MMM YYYY') +
                            ' / ' +
                            dayjs(festival.endDate).format('DD MMM YYYY')
                        }
                    />
                    ...
                    <LineUp
                        data={festival.shows}
                        selected={this.state.radioTagSelect}
                        direction="column"
                    ></LineUp>
                </ScrollContainer>
            </SafeAreaView>
    ...
    returnToInscriptions() {
        this.props.setIsActualSelectedFestivals(false)
    }
                        ...
                        <View style={{paddingHorizontal: 20, paddingTop: 10}}>
                            ...
                            <View style={[styles.friendlist, styles.view]}>
                                {friendsInscription === null || friendsInscription === [] ? (
                                    ...
                                    <FriendsInscriptionList
                                        data={friendsInscription.filter((item) => item.festival.id === festival.id)}
                                    />
                                )}
                            </View>
                            <View>
                                            ...
                                            <View style={styles.centeredView}>
                                                ...
                                                <View style={styles.modalView}>
                                                    <Pressable
                                                        ...
                                                        onPress={() => {
                                                            this.inscriptionFestivalUser(festival.id, actualUser.id),
                                                                this.setModalVisible();
                                                        }}
                                                    >
